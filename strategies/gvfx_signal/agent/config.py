...
class Settings:
    ...
    mt5_symbols: List[str]      # e.g. ["XAUUSD"]

    # Optional with defaults
    redis_url: str = "redis://localhost:6379"
    redis_stream: str = "gvfx_signals"
    redis_group: str = "gvfx_writer"
    redis_consumer: str = "gvfx-agent-1"
    log_level: str = "INFO"
...
def load_settings() -> Settings:
    ...
    return Settings(
        ...
        redis_stream=os.environ.get("REDIS_STREAM", "gvfx_signals"),
        redis_group=os.environ.get("REDIS_GROUP", "gvfx_writer"),
        redis_consumer=os.environ.get("REDIS_CONSUMER", "gvfx-agent-1"),
