"""Outcome publisher — file → Redis Stream `gvfx_outcomes`.
...
- Dedup uses Redis SET `gvfx_outcomes:ingested` (SISMEMBER + SADD).
...
STREAM_NAME      = "gvfx_outcomes"
INGESTED_SET_KEY = "gvfx_outcomes:ingested"
...
def _cli() -> int:
    parser = argparse.ArgumentParser(description="Publish GVFX outcome files to Redis Stream")
